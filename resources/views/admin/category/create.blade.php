                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$lastSortNumber}}" id="name"
                                                                   class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="type_category" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر نوع القسم ">
                                                                    ...
                                                                    <option value="2">مقدمي خدمات</option>
                                                                    <option value="3">المناسبات العامه</option>
                                                                    <option value="4">فيديوهات افراح القبائل </option>
                                                                    <option value="5">قبائل</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('type_category')
                                                            <span class="text-danger">{{$message}}</span>
