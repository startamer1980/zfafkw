                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="{{route('admin.category.sub_category', $cat_id)}}"> {{$main_cat->name}}</a>
                                </li>
                                <li class="breadcrumb-item active">
                                    تعديل
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.category.sub_category.update', [$cat_id, $cat->id])}}" method="POST"
